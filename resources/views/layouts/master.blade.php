...
<aside class="app-sidebar">
    ...
    <ul class="app-menu">
        ...
        {{--<li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-file-text"></i><span class="app-menu__label">Pages</span><i class="treeview-indicator fa fa-angle-right"></i></a>--}}
            ...
            {{--</ul>--}}
        {{--</li>--}}
        <li><a class="app-menu__item active" href="index.html"><i class="app-menu__icon fa fa-newspaper"></i><span class="app-menu__label">Article</span></a></li>
    </ul>
</aside>
...
<script src="{{asset('vali-admin/docs/js/jquery-3.2.1.min.js')}}"></script>
<script src="{{asset('vali-admin/docs/js/popper.min.js')}}"></script>
<script src="{{asset('vali-admin/docs/js/bootstrap.min.js')}}"></script>
<script src="{{asset('vali-admin/docs/js/main.js')}}"></script>
<!-- The javascript plugin to display page loading on top-->
<script src="{{asset('vali-admin/docs/js/plugins/pace.min.js')}}"></script>
<!-- Page specific javascripts-->
<script type="text/javascript" src="{{asset('vali-admin/docs/js/plugins/chart.js')}}"></script>
